...
/**
 * Parses the PHP code section of SnakeTemplate objects.
 */
class CodeParser
{
    /**
     * @var \Winter\Battlesnake\Models\SnakeTemplate A reference to the object being parsed.
     */
    protected $object;
     ...
     */
    public function __construct(SnakeTemplate $object)
    {
        $this->object = $object;
    ...
    public function parse()
    {
        ...
        if (is_file($path)) {
             ...
             */
            if ($hasCache && $cachedInfo['mtime'] == $this->object->updated_at) {
    ...
    */
     ...
     */
    public function source(array $state, array $options): Snake
    {
        $data = $this->parse();
    ...
    {
        $cacheItem = $result;
        $cacheItem['mtime'] = $this->object->updated_at;
